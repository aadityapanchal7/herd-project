...
export function ChatMessageItem({ 
  ...
  const getUserReaction = (reactions: MessageReaction[], userId: string) => {
    return reactions.find(r => r.users.some(u => u.user_id === userId))
  }
          ...
          <div className="flex flex-wrap gap-1 px-3">
            {message.reactions.map((reaction) => {
              const hasReacted = currentUserId ? 
                reaction.users.some(u => u.user_id === currentUserId) : false
